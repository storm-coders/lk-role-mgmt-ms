...
public enum ValidationError {
    ...
    INVALID_GROUP_NM(ErrorConstants.INVALID_GROUP_NAME_CD, ErrorConstants.INVALID_GROUP_NAME_MSG),
    INVALID_GROUP_PRIVILEGE(ErrorConstants.INVALID_GROUP_PRIVILEGES_CD, ErrorConstants.INVALID_GROUP_PRIVILEGES_MSG)
    ;
